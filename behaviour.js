...
if ((p1_batu && p2_gunting) || (p1_gunting && p2_kertas) || (p1_kertas && p2_batu)){
    document.querySelector("#pesan_p1").innerHTML = "Yeyy, Kamu Menang !"
    document.querySelector("#pesan_p2").innerHTML = "Yah Maaf, Kamu Kalah"
...
if ((p2_batu && p1_gunting) || (p2_gunting && p1_kertas) || (p2_kertas && p1_batu)){
    document.querySelector("#pesan_p1").innerHTML = "Yah Maaf, Kamu Kalah"
    document.querySelector("#pesan_p2").innerHTML = "Yeyy, Kamu Menang !"
...
// seri
if (acak == acak2){
    document.querySelector("#pesan_p1").innerHTML = "Seri nih, coba lagi"
    document.querySelector("#pesan_p2").innerHTML = "Seri nih, coba lagi"
